...
public class Assignment1 {
  public static void main(String[] args) {
    ...
    System.out.println("The runtime of your battery is: " + hours + " hours and " + mins + " minutes at a rate of " + current + " amps per hour");
