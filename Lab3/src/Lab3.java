...
/**
 You are to take the if test below and implement the grade scale we are using for
 CS401 including the + and - levels of each letter grade:
 ...
 score < 60% == F
 NOTE!!!! Since you are having to store a 2 character value for the letter grade,
 you likely will need to choose a datatype that isn't char!
 */
public class Lab3
{
